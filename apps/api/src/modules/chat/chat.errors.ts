...
export const ChatErrorCodes = {
    ...
    NotMessageSender: "CHAT_NOT_MESSAGE_SENDER",
    MessageWindowExpired: "CHAT_MESSAGE_WINDOW_EXPIRED",
...
const CHAT_ERROR_STATUS: Record<ChatErrorCode, number> = {
    ...
    [ChatErrorCodes.MessageNotFound]: 404,
    [ChatErrorCodes.NotAParticipant]: 403,
    [ChatErrorCodes.NotMessageSender]: 403,
    [ChatErrorCodes.MessageWindowExpired]: 403,
