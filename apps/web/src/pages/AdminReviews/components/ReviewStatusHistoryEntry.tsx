...
import type { AdminReviewStatusHistoryItem } from "../../../api-client/model/adminReviewStatusHistoryItem";
import { fullName, formatDate } from "../lib/format";
import { useReviewStatusLabels } from "../lib/labels";

export function ReviewStatusHistoryEntry({
    entry,
}: {
    entry: AdminReviewStatusHistoryItem;
}) {
